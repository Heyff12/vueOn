<template>
    <div>
            ...
            <el-row :gutter="10">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="6">
                    <dl class="home_dl dl_two">
                        <dt>{{$t('home.dataBank.newNum')}}</dt>
                        <dd><span class="data_span">{{yester_data.new_mchnt_cnt}}</span>{{$t('app.unitGe')}}</dd>
                    </dl>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="6">
        ...
        <div class="home_body_b">
            <div class="line_pic">
                <p class="title">{{$t('home.lineBank.tradeLine')}}</p>
                <!-- <div class="select">
            ...
            <div class="line_pic">
                <p class="title title2">{{$t('home.lineBank.merchantLine')}}</p>
...
export default {
    ...
    methods: {
        ...
        get_yester: function() {
            let _this = this;
            this.$ajax_log.ajax_get(this, this.yester_url, '', (data_return) => {
        ...
        get_salesman: function() {
            ...
            this.$ajax_log.ajax_get(this, this.salesman_url, '', (data_return) => {
        ...
        trade_line: function() {
            ...
            _this.trade.setOption({
                ...
                xAxis: {
                    name: _this.$t('home.lineBank.trade_x'),
                    data: _this.trade_y_data,
                },
                yAxis: {
                    name: _this.$t('home.lineBank.trade_y') + _this.$store.state.currency,
                    type: 'value',
                    boundaryGap: ['0%', '5%'],
                },
                series: [{
                    name: _this.$t('home.lineBank.trade_d'),
                    type: 'line',
                    smooth: true,
                    smoothMonotone: 'x',
        ...
        salesman_line: function() {
            ...
            _this.salesman.setOption({
                ...
                tooltip: {},
                xAxis: {
                    name: _this.$t('home.lineBank.merchant_x'),
                    data: _this.salesman_x_data
                },
                yAxis: {
                    name: _this.$t('home.lineBank.merchant_y'),
                },
                series: [{
                    name: _this.$t('home.lineBank.merchant_d'),
                    type: 'line',
                    smooth: true,
