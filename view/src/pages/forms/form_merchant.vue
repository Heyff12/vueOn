<template>
    <div>
        <div class="right_head">
            {{$t('formMer.titleBank.title')}}
        </div>
        <div class="right_body forms_form">
            <div class="line_pic">
                <div class="select">
                    <el-date-picker v-model="sel_day" type="date" :picker-options="pickerOptions" @change="change_date" format="yyyy-MM-dd">
                    </el-date-picker>
                </div>
    ...
    methods: {
        ...
        formpic_line: function() {
            ...
            _this.from_now.setOption({
                ...
                xAxis: {
                    name: _this.$t('formMer.bodyBank.lineX'),
                    data: _this.form_x_data,
                },
                yAxis: {
                    name: _this.$t('formMer.bodyBank.lineY')+_this.$store.state.currency,
                    type: 'value',
                    boundaryGap: ['0%', '5%'],
                },
                series: [{
                    name: _this.$t('formMer.bodyBank.lineD'),
                    type: 'line',
                    smooth: true,
                    smoothMonotone: 'x',
