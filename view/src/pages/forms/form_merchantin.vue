<template>
    <div>
        <div class="right_head">
            {{$t('formMerchantin.titleBank.title')}}
        </div>
        <div class="right_body forms_form select">
            <div class="line_pic">
                <div class="select wid_long">
                    <span class="sel_title">{{$t('formMerchantin.bodyBank.selTime')}}：</span>
                    <el-date-picker v-model="sel_day" type="date" :placeholder="$t('formMerchantin.bodyBank.timePlace')" :picker-options="pickerOptions" @change="change_date" format="yyyy-MM-dd">
                    </el-date-picker>
                </div>
    ...
    methods: {
        ...
        formpic_line: function() {
            ...
            _this.from_now.setOption({
                ...
                // }],
                xAxis: {
                    name: _this.$t('formMerchantin.bodyBank.lastWeek'),
                    data: _this.form_x_data,
                },
                yAxis: {
                    name: _this.$t('formMerchantin.bodyBank.merInNum'),
                    type: 'value',
                    boundaryGap: ['0%', '5%'],
                },
                series: [{
