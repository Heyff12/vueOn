        ...
        <div class="right_body">
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
                        <el-form-item :label="$t('generalPro.searchBank.payStatus')">
                            <el-select v-model="searchkey.trade_status">
                                ...
                                <el-option :label="$t('generalPro.searchBank.success')" value="成功"></el-option>
                                <el-option :label="$t('generalPro.searchBank.failure')" value="失败"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
                    ...
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
                        <el-form-item :label="$t('generalPro.searchBank.endTime')">
                            <el-date-picker v-model="searchkey.trade_end_time" type="datetime" align="right" :picker-options="pickerOptions_e" format="yyyy-MM-dd HH:mm:ss" @change="" popper-class="no_now" :editable="false" :clearable="false">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
            ...
            <template>
                <el-table :data="trade_now" border stripe style="width: 100%">
                    ...
                    <el-table-column prop="trade_status" :label="$t('generalPro.bodyBank.tradeStatus')" resizablemin-width="100px">
                    </el-table-column>
