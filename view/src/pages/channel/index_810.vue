            ...
            <el-form :model="base" :rules="rules" ref="base1" label-width="110px" class="demo-ruleForm">
              <el-row :gutter="20">
                ...
                <el-col :xs="24" :sm="24" :md="24" :lg="24">
                  <div class="clearfix_liner1"></div>
                  <div class="add_quyu">
                    <el-button type="primary" icon="plus" @click="add_quyu">增加授权区域</el-button>
                  </div>                
                </el-col>
                <!-- <el-col :xs="24" :sm="24" :md="12" :lg="8">
                  <el-form-item label="省份" prop="auth_province">
                    <el-select v-model="base.auth_province" placeholder="请选择授权省份" v-on:change="select_authpro" filterable>
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="8">
                  <el-form-item label="市" prop="auth_city">
                    <el-select v-model="base.auth_city" placeholder="请选择授权城市" filterable>
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="8">
                  <el-form-item label="区" prop="auth_city">
                    <el-select v-model="base.auth_city" placeholder="请选择授权城市" filterable>
                      <el-option v-for="auth_city in authcitys" v-bind:cityid="auth_city.cityid" v-bind:value="auth_city.cityname" v-bind:label="auth_city.cityname">
                      </el-option>
                    </el-select>
                ...
                <template v-for="(item,index) in base.auth_areas">
                  <el-col :xs="24" :sm="24" :md="12" :lg="8">
                    <el-form-item label="授权省份" :rules="[{required: true,message: '请选择所在授权省份',trigger: 'change'}]">
                  ...
                  <el-col :xs="24" :sm="24" :md="12" :lg="8">
                    <el-form-item label="授权市" :rules="[{required: false,message: '请选择所在授权城市',trigger: 'change'}]">
                      <el-select v-model="item.auth_city" placeholder="请选择授权城市" filterable v-on:change="select_authcity(index)">
                  ...
                  <el-col :xs="24" :sm="24" :md="12" :lg="8">
                    <el-form-item label="授权区" :rules="[{required: false,message: '请选择所在授权区',trigger: 'change'}]">
                      <el-select v-model="item.auth_county" placeholder="请选择授权区域" filterable>
                        <el-option v-for="auth_county in authcountys[index].countys" v-bind:countyid="auth_county.countyid" v-bind:value="auth_county.countyname" v-bind:label="auth_county.countyname">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
  ...
  data() {
    ...
    return {
      ...
      base: {
        ...
        "currency": "", // 币种
        "areas":[],
        'auth_areas':[{"auth_province": "", "auth_city": "",  "auth_county": ""}],//地址列表-----------地址列表
      },
      account: {
