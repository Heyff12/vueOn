    ...
    <div class="right_body">
        ...
        <el-row :gutter="10">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="6">
              <el-form-item :label="$t('generalPro.searchBank.auditStatus')">
                  <el-select v-model="searchkey.audit_statuses" :placeholder="$t('generalPro.searchBank.auditStatusD')" multiple>
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="6">
            <el-form-item label-width="0" class="t_c">
              ...
              <el-button type="default" @click="download_sub">{{$t('merchantlList.searchBank.download')}}</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <template>
        <el-table :data="merchants_now" border stripe style="width: 100%">
          <el-table-column prop="qd_info.base.userid" :label="$t('generalPro.bodyBank.qdNum')" resizable min-width="80px">
          </el-table-column>
            ...
            <template scope="scope">
              <div v-if="scope.row.fee_ratios || scope.row.settle_cycle"> 
                <el-popover trigger="click" placement="bottom-end" popper-class="popover_new">
                  ...
                  <span slot="reference" class="hover_color" @click="middle_fee=scope.row.fee_ratios">{{$t('app.clickScan')}}</span>
                </el-popover>
              </div>
            </template>
          </el-table-column>
