        ...
        <div class="right_body">
            <template>
                <el-table :data="products" ref="products" border stripe style="width: 100%" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column prop="product_id" :label="$t('generalPro.bodyBank.proNo')" resizable min-width="120px">
                    </el-table-column>
                    <el-table-column prop="name" :label="$t('generalPro.bodyBank.proName')" resizable min-width="100px">
                    </el-table-column>
                    <el-table-column prop="intro" :label="$t('generalPro.bodyBank.proDes')" resizable min-width="170px">
                    </el-table-column>
                </el-table>
            </template>
            <el-form label-width="125px" class="demo-ruleForm">
                <div class="mar_t20 t_c">
                    <el-col :xs="24" :sm="24" :md="24" :lg="24">
                        <el-button type="primary" @click="mend">{{$t('app.modify')}}</el-button>
    ...
    methods: {
        ...
        mend: function() {
            ...
            if (_this.product.length <= _this.product_start) {
                _this.toastmsg = _this.$t('generalPro.bodyBank.proSel');
        ...
        fix_base: function() {
            ...
            this.$ajax_log.ajax_post(this, this.products_url, post_data, (data_return) => {
                _this.visible_toast = true;
                _this.toastmsg = _this.$t('channelList.bodyBank.proSuccess');
            });
        ...
        get_products: function() {
            var _this = this;
            this.$ajax_log.ajax_get(this, this.products_url, '', (data_return) => {
